...
3) Clone OpenPIV repository of your choice (e.g. Matlab, C++ or Python) using::

    git clone http://github.com/OpenPIV/openviv-matlab.git
...
use the first language from the following which you are confortable with: C, C++, Python, etc.. If you have existing, debugged, tested code that
